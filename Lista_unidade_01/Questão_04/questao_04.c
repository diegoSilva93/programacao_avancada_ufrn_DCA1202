...
/* (f) */
    p3 = p3 + 4;
    //levando em consideraçõa que a variael p3 já foi utilizado e guarda o valor e + 4 ela recebera o ultimo valor do array "ponteiros", então a saída será "s"
    printf("%c \n", *p3);
...
//------------------ TODOS CORRESPONDERAM COM A EXPECTATIVA DE RESPOSTA ------------------- //
